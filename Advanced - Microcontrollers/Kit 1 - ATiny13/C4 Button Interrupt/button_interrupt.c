...
int main(void) {
	...
	//MCUCR = _BV (ISC01); // Set falling edge. See ATtiny13 data sheet table 9-2
	MCUCR = _BV (ISC00); // Trigger on both rising/Falling edge. See ATtiny13 data sheet table 9-2
